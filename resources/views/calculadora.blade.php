...
<body class="bg-[#181f32] min-h-screen flex items-center justify-center p-4"
    ...
    <form action="#" method="POST" class="w-full max-w-md flex flex-col gap-6">
        ...
        <div class="bg-[#182034] p-6 rounded-xl text-right text-white border border-transparent shadow-inner">
            <div class="text-slate-400 text-sm h-5 font-bold tracking-wide mb-1"></div>
            <div class="text-5xl font-bold tracking-tight overflow-x-auto select-all">0</div>
        </div>
